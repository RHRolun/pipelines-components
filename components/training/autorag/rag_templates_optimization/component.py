...
def rag_templates_optimization(
    ...
    INDEXING_CELLS_TEMPLATES: MappingProxyType[
        Literal[
            "BANNER",
            "TABLE_OF_CONTENTS",
            "CHAPTER_1",
    ...
    ] = MappingProxyType(
        {
            ...
            "DEPENDENCIES": NotebookCell(
                ...
                source=[
                    ...
                    "!pip install 'ai4rag=={AUTORAG_VERSION}' | tail -n 1",
                ],
            ),
            "MD_1_1": NotebookCell(
                cell_type="markdown",
    ...
    GENERATION_CELLS_TEMPLATES: MappingProxyType[
        Literal[
            "BANNER",
            "TABLE_OF_CONTENTS",
            "CHAPTER_1",
    ...
    def generate_notebook_from_templates(
        templates_dict: dict[str, NotebookCell] | MappingProxyType,
        output_data: dict[str, Any],
        ...
        return {
            ...
            "settings": {
                ...
                "embedding": {
                    ...
                    "embedding_params": embeddings.get("embedding_params", {}),
                },
                "retrieval": {
