"""Tests for the timeseries_models_full_refit component."""

from ..component import timeseries_models_full_refit
...
class TestTimeseriesModelsFullRefitUnitTests:
    ...
    def test_component_function_exists(self):
        ...
        assert callable(timeseries_models_full_refit)
        assert hasattr(timeseries_models_full_refit, "python_func")
    ...
    def test_component_with_default_parameters(self):
        ...
        result = timeseries_models_full_refit.python_func(input_param="test_value")
