"""Local runner tests for the timeseries_models_full_refit component."""

from ..component import timeseries_models_full_refit


class TestTimeseriesModelsFullRefitLocalRunner:
    ...
    def test_local_execution(self, setup_and_teardown_subprocess_runner):  # noqa: F811
        ...
        result = timeseries_models_full_refit(input_param="test_value")
